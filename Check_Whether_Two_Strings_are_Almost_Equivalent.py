...
def checkAlmostEquivalent(word1, word2):
    ...
    :rtype: bool
    """
    # make an array to track occurences for every letter of the word1 and word2
...
print(checkAlmostEquivalent("aaaa", "bccb"))#False
print(checkAlmostEquivalent("abcdeef", "abaaacc"))#True
print(checkAlmostEquivalent("cccddabba", "babababab"))#True
